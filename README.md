...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/nbmake-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14481&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/nbmake-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `nbmake` can be installed with:

```
conda install nbmake
```

It is possible to list all of the versions of `nbmake` available on your platform with:
